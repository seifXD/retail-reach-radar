      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Recharge Goal</CardTitle>
            <Target className="h-4 w-4" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(rechargeGoal)}</div>
            <p className="text-xs text-blue-100">Monthly target</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-green-100">{progressPercentage.toFixed(1)}% of goal</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(rechargeGoal - currentProgress)}</div>
            <p className="text-xs text-orange-100">To reach goal</p>
          </CardContent>
        </Card>
      </div>
